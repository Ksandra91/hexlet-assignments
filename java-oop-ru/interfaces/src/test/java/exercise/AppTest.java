...
class AppTest {
    ...
    void testToString() {
        ...
        String actual = new ReversedSequence("abcdef").toString();
    ...
    void testCharAt() {
        char expected = 'e';
        char actual = new ReversedSequence("abcdef").charAt(1);
        assertThat(expected).isEqualTo(actual);
    }
    ...
    void testSubSequence() {
        String expected = "edc";
        String actual = new ReversedSequence("abcdef").subSequence(1, 4).toString();
        assertThat(expected).isEqualTo(actual);
    }
    // END
}
